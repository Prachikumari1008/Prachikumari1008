...
function fetchData(user_country) {
   // user_country = country;
    ...
    const api_fetch = async (user_country) => {
      await fetch(
        "https://api.covid19api.com/total/country/" + user_country + "/status/confirmed",
        requestOptions
      )
        .then((res) => {
          return res.json();
      ...
      await fetch(
        "https://api.covid19api.com/total/country/" + user_country + "/status/recovered",
        requestOptions
      )
        .then((res) => {
          return res.json();
      ...
      await fetch(
        "https://api.covid19api.com/total/country/" + user_country + "/status/deaths",
        requestOptions
      )
        .then((res) => {
          return res.json();
  ...
  function updateStats() {
    ...
    // new_cases_element.innerHTML = last_entry.new_cases;
